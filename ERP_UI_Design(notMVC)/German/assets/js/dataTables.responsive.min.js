...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || typeof Object.defineProperties === "function" ? Object.defineProperty : function(b, k, m) {
...
$jscomp.polyfillIsolated = function(b, k, m, n) {
    ...
    b = 1 === p.length;
    p = p[0];
    p = !b && p in $jscomp.polyfills ? $jscomp.polyfills : $jscomp.global;
    ...
    y = p[p.length - 1];
    m = $jscomp.IS_SYMBOL_NATIVE && "es6" === m ? p[y] : null;
    k = k(m);
    null != k && (b ? $jscomp.defineProperty($jscomp.polyfills, y, {
        configurable: !0,
        writable: !0,
        value: k
    }) : k !== m && ($jscomp.propertyToPolyfillSymbol[y] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(y) : $jscomp.POLYFILL_PREFIX + y, y = $jscomp.propertyToPolyfillSymbol[y], $jscomp.defineProperty(p, y, {
        configurable: !0,
        writable: !0,
        value: k
    })));
...
(function(b) {
    ...
    b.extend(u.prototype, {
        ...
        _columnsVisiblity: function(a) {
            var c = this.s.dt,
                d = this.s.columns,
                f, g, l = d.map(function(h, e) {
                    return {
                        columnIdx: e,
                        priority: h.priority
                    }
                }).sort(function(h, e) {
                    return h.priority !== e.priority ? h.priority - e.priority : h.columnIdx - e.columnIdx
                }),
                h = b.map(d, function(h, e) {
                    return !1 === c.column(e).visible() ? "not-visible" : h.auto && null === h.minWidth ? !1 : !0 === h.auto ? "-" : -1 !== b.inArray(a, h.includeIn)
                }),
                e = 0;
            var r = 0;
            for (f = h.length; r < f; r++) !0 === h[r] && (e += d[r].minWidth);
            r = c.settings()[0].oScroll;
            r = r.sY || r.sX ? r.iBarWidth : 0;
            e = c.table().container().offsetWidth - r - e;
            r = 0;
            for (f = h.length; r < f; r++) d[r].control && (e -= d[r].minWidth);
            r = !1;
            f = 0;
            for (f = g = d.length; r < g; r++) {
                var l = g = d[r].columnIdx;
                if (!1 === h[l] && !d[l].never && !1 === c.column(l).visible()) {
                    r = !0;
                    break
                }
            }
            r = 0;
            for (f = d.length; r < f; r++) d[r].control && (h[r] = !0), "not-visible" === h[r] && (h[r] = !1);
            -1 === b.inArray(!0, h) && (h[0] = !0);
            return h
        },
        _classLogic: function() {
          ...
          _detailsObj: function(a) {
            ...
            return b.map(this.s.columns, function(f, g) {
              if (!f.never && !f.control) return f = c.settings()[0].aoColumns[g], {
                className: f.sClass,
                columnIndex: g,
                data: c.cell(a, g).render(d),
                hidden: c.column(g).visible() && !this.s.current[g],
                rowIndex: a,
                title: null !== f.sTitle ? f.sTitle : b(c.column(g).header()).text()
              }
            })
          },
          _find: function(a) {
            ...
            modal: function (a) {
              return function (c, d, f) {
                if (d) {
                  ...
                  var l = b('<div class="dtr-modal"/>').append(b('<div class="dtr-modal-display"/>').append(b('<div class="dtr-modal-content"/>').append(f())).append(b('<div class="dtr-modal-close">&times;</div>').click(function () {
                    g();
          ...
          u.renderer = {
            listHiddenNodes: function () {
              return function (a, c, d) {
                ...
                b.each(d, function (l, h) {
                  if (h.hidden) {
                    b("<li " + (h.className ? 'class="' + h.className + '"' : '') + ' data-dtr-index="' + h.columnIndex + '" data-dt-row="' + h.rowIndex + '" data-dt-column="' + h.columnIndex + '"><span class="dtr-title">' + h.title + "</span> </li>")
            ...
            listHidden: function () {
              return function (a, c, d) {
                ...
                }).join("")) ? b('<ul data-dtr-index="' + c + '" class="dtr-details"/>').append(a) : false;
              }
            },
            tableAll: function (a) {
          ...
          C.register("responsive.hasHidden()", function () {
            ...
            return a._responsive ? -1 !== b.inArray(false, a._responsive._responsiveOnlyHidden()) : false;
          });
          
          C.registerPlural("columns().responsiveHidden()", "column().responsiveHidden()", function () {
            return this.iterator("column", function (a, c) {
              return a._responsive ? a._responsive._responsiveOnlyHidden()[c] : false;
            }, 1);
          });
          ...
          b(m).on("preInit.dt.dtr", function (a, c, d) {
            if ("dt" === a.namespace && (b(c.nTable).hasClass("responsive") || b(c.nTable).hasClass("dt-responsive") || c.oInit.responsive || z.defaults.responsive)) {
              a = c.oInit.responsive;
              if (a !== false) {
                new u(c, b.isPlainObject(a) ? a : {});
              }
            }
        });
