...
//#region  Tokenize--- CSS parçalama, bölme, seçerek kullanma.
...
//#region  Combinator--- CSS kodlarını birbirine uyumlu şekilde işleme.
...
//#region Compile--- CSS Tokenize ve Combinator'da select işlemini daha verimli kullanmak içi.
...
//#region Sizzlenin derlenmiş select işlevlerini kullanarak veya basit bir select ifadesiyle belirli bir bağlam içinde öğeleri seçmeye yardımcı olur
...
//#region UMD -- Farklı tarayıcılara uyumluluk vs.
;(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
    typeof define === 'function' && define.amd ? define(factory) :
    ...
    var defaultLocaleMonths = 'Ocak_Şubat_Mart_Nisan_Mayıs_Haziran_Temmuz_Ağustos_Eylül_Ekim_Kasım_Aralık'.split(
            '_'
        ),
        defaultLocaleMonthsShort = 'Oca_Şub_Mar_Nis_May_Haz_Tem_Ağu_Eyl_Eki_Kas_Ara'.split(
            '_'
        ),
    ...
    var defaultLocaleWeekdays = 'Pazar_Pazartesi_Salı_Çarşamba_Perşembe_Cuma_Cumartesi'.split(
        ...
        defaultLocaleWeekdaysMin = 'Pa_Pz_Sa_Ça_Pr_Cu_Ct'.split('_'),
    ...
    var extendedIsoRegex = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([+-]\d\d(?::?\d\d)?|\s*Z)?)?$/,
        ...
        rfc2822 = /^(?:(Pzt|Salı|Çrş|Prş|Cum|Cmt|Paz),?\s)?(\d{1,2})\s(Oca|Şub|Mar|Nis|May|Haz|Tem|Ağu|Eyl|Eki|Kas|Ara)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/,
        obsOffsets = {
            UT: 0,
            GMT: 0,
            EDT: -4 * 60,
...
//#region Sayfa scorll işlemleri için SimpleBar
...
//#endregion
 ...
 //#region TouchSping - Değer Ekleme/Azaltma vs.
